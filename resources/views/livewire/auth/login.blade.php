<div class="bg-void-DEFAULT font-grotesk text-gray-200 overflow-x-hidden overflow-y-hidden min-h-screen relative">
    <!-- Background pattern -->
            ...
            <div class="flex items-center space-x-3">
                <div class="w-10 h-10 bg-cosmic-DEFAULT rounded-lg flex items-center justify-center rotate-45">
                    <span class="-rotate-45 inline-block w-14 h-14">
                        <img href="https://imgbb.com/"><img src="https://i.ibb.co/dsrhBFpQ/stembayo-1.png" alt="Logo" class="w-14 h-14 object-contain">
                    </span>
                </div>
        ...
        <div class="flex flex-col lg:flex-row items-center">
            ...
            <div class="lg:w-1/2 mb-16 lg:mb-0">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8">
                    <span class="text-cosmic-light cyber-glow">Login ke</span><br>
                ...
                <p class="text-lg text-gray-300 mb-10 max-w-lg">
                    Masuk ke akun Anda untuk mulai membuat, mengelola, dan melacak laporan Praktik Kerja Lapangan dengan mudah.
                </p>
            </div>
