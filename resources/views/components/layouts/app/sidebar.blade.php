    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="home" :href="route('guru')" :current="request()->routeIs('guru')" wire:navigate>
                    {{ __('Guru') }}
                </flux:navlist.item>
                <flux:navlist.item icon="home" :href="route('siswa')" :current="request()->routeIs('siswa')" wire:navigate>
                    {{ __('Siswa') }}
                </flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
